#not done by me, it was done by:https://github.com/xHyroM

file = open("C:/Users/costa/OneDrive/Documentos/Programming/Extras/adventofcode2023/day05/input.txt").read().strip().split("\n\n")
